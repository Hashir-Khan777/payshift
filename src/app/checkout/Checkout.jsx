...
const CheckOutComponent = ({
  ...
  return (
    <div className="w-[100%] flex flex-col justify-center gap-10 items-center mx-auto md:pt-10 pt-14 pb-32 overflow-hidden">
      ...
      {/* ------------ */}
      <div className="mx-auto md:w-[724px] w-[90%] py-[32px] px-[24px] flex flex-row flex-wrap justify-between gap-5 border-2 border-white rounded-md"
        style={{
      ...
      >
        <div className="flex flex-col gap-2 justify-start">
          <p className="md:text-[16px]/[17.5px] text-[14ppx] font-[400] text-[#000000]">To Pay</p>
          <p className="text-[20px]/[25px] font-[500] text-[#17A900]">AED {cards.amount}</p>
        </div>
        <div className="flex flex-col gap-2 justify-start">
          <p className="md:text-[16px]/[17.5px] text-[14ppx] font-[400] text-[#000000]">Reference No</p>
          <p className="text-[20px]/[25px] font-[600] text-[#000000]]">AED {cards.refNo}</p>
        </div>
        <div className="flex flex-col gap-2 justify-start">
          <p className="md:text-[16px]/[17.5px] text-[14ppx] font-[400] text-[#000000]">Merchent Name</p>
          <p className="text-[20px]/[25px] font-[600] text-[#000000]">{cards.merchentName}</p>
        </div>
      ...
      <div className="flex flex-row md:gap-4 gap-2 md:px-0 px-3">
        ...
        <div className="rounded-[4px] shadow-lg md:h-[87px] md:w-[163px] md:px-0 md:py-0 px-5 py-4 flex flex-col justify-center items-center gap-1"
          ...
          <img className="md:w-[30px] w-[24px] md:h-[30px] h-[24px]" src="/svgIcons/card.svg" />
          <span className="md:text-[20px]/[25px] text-[12px]/[15px] font-[500] font-lexend">Card</span>
        </div>

        <div className="rounded-[4px] shadow-lg md:h-[87px] md:w-[163px] md:px-0 md:py-0 px-5 py-4 flex flex-col justify-center items-center gap-1">

          <BsBank2 className="text-gray-400 md:w-[30px] w-[24px] md:h-[30px] h-[24px]" />
          <span className="md:text-[20px]/[25px] text-[12px]/[15px] font-[500] font-lexend text-gray-400">Bank</span>
        ...
        <div className="rounded-[4px] shadow-lg md:h-[87px] md:w-[163px] md:px-0 md:py-0 px-5 py-4 flex flex-col justify-center items-center gap-1">
          ...
          <span className="md:text-[20px]/[25px] text-[12px]/[15px] font-[500] font-lexend text-gray-400 whitespace-nowrap">Apple Pay</span>
        ...
        <div className="rounded-[4px] shadow-lg md:h-[87px] md:w-[163px] md:px-0 md:py-0 px-5 py-4 flex flex-col justify-center items-center gap-1">
          ...
          <span className="md:text-[20px]/[25px] text-[12px]/[15px] font-[500] font-lexend text-gray-400">Paypal</span>
      ...
      <div
        className="md:w-[724px] w-[100%] flex flex-col md:gap-10 gap-5 p-6 rounded-lg">

        {/* Card Number */}
        <div className="flex flex-col gap-2 md:w-[326px] w-[90%] mx-auto">
          <label className="md:text-[24px]/[30px] text-[14px]/[17.5px] font-lexend font-[400]">Card Number</label>
        ...
        {/* Cardholder Name */}
        <div className="flex flex-col gap-2 md:w-[326px] w-[90%] mx-auto">
          <label className="md:text-[24px]/[30px] text-[14px]/[17.5px] font-lexend font-[400]">Cardholder Name</label>
          <div className="md:w-[326px] w-full h-[40px] flex items-center gap-2 bg-white  py-[8px] px-[20px] shadow-xl">
        ...
        <div className="mx-auto md:w-[326px] w-[90%] flex flex-row justify-center items-center gap-4">
          ...
          <div className="flex flex-col gap-2 md:w-[158px] w-[45%] mx-auto">
              ...
              <label className="text-[14px]/[17.5px] font-[400] text-[#000000] font-lexend">Valid Until</label>
          ...
          <div className="flex flex-col gap-2 md:w-[158px] w-[45%] mx-auto">
            ...
            <label><span className="text-[14px]/[17.5px] font-[400] text-[#000000] font-lexend">CVV</span></label>
        ...
        <div className="flex flex-row gap-2 md:w-[326px] w-[90%] mx-auto">
          <input type="checkbox" id="save-card" className="w-4 h-4 bg-transparent border-black border-2 text-black" />
      ...
      <p className="text-[12px]/[15px] font-[300] text-center font-lexend tracking-[4%] px-5">Our checkout is totally secure. Your personal information is securely transmitted via 128-bit encryption.</p>
