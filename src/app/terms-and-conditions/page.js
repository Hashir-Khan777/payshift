  ...
  return (
    ...
    >
      ...
      <div className='w-[90%] py-10 flex flex-col gap-4'>
        ...
        <h3 className='md:text-[14px]/[17.5px] [12px]/[15px] tracking-[4%] font-[600]'>2. PRIVACY</h3>
        ...
        <h3 className='md:text-[14px]/[17.5px] [12px]/[15px] tracking-[4%] font-[600]'>3. LINKED SITES</h3>
