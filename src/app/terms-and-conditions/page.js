...
const page = () => {
  return (
    <div className='w-[100%] min-h-[100vh] py-10 flex flex-col justify-center items-center'
      style={{
    ...
    >
      ...
      <div className='w-[90%] py-10 flex flex-col gap-4'>
        ...
        <h3 className='md:text-[14px]/[17.5px] [12px]/[15px] tracking-[4%] font-[600] font-lexend'>1. YOUR AGREEMENT</h3>
        ...
        <h3 className='md:text-[14px]/[17.5px] [12px]/[15px] tracking-[4%] font-[600] font-lexend'>2. PRIVACY</h3>
        <p className='font-lexend font-[400] md:text-[14px]/[17.5px] [12px]/[15px] tracking-[4%]'>Please review our Privacy Policy, which also governs your visit to this Site, to understand our practices.</p>

        <h3 className='md:text-[14px]/[17.5px] [12px]/[15px] tracking-[4%] font-[600] font-lexend'>3. LINKED SITES</h3>
        <p className='font-lexend font-[400] md:text-[14px]/[17.5px] [12px]/[15px] tracking-[4%]'>This Site may contain links to other independent third-party Web sites ("Linked Sites”). These Linked Sites are provided solely as a convenience to our visitors. Such Linked Sites are not under our control, and we are not responsible for and does not endorse the content of such Linked Sites, including any information or materials contained on such Linked Sites. You will need to make your own independent judgment regarding your interaction with these Linked Sites.</p>

        <h3 className='md:text-[14px]/[17.5px] [12px]/[15px] tracking-[4%] font-[600] font-lexend'>4. FORWARD LOOKING STATEMENTS</h3>
