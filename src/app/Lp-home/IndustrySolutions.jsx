    ...
    return (
        ...
        >
            ...
            <div className="w-full flex flex-col gap-[80px] px-[100px]">
                ...
                {/* Timeline */}
                <div className="w-full relative px-2 " ref={ref}>
                    {/* Timeline Line */}
                    ...
                    {timelineItems.map((item, index) => (
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                <p className="word-break-auto-phrase lg:text-[24px]/[30px] text-[15px]/[20px] font-lexend  text-black" style={{ wordBreak: "auto-phrase" }}>
                                    {item.description}
                                </p>
                            </motion.div>
                        </div>
