...
const ResetPassword3 = () => {
    ...
    return (
        <div className='w-full flex flex-col justify-center items-center md:gap-10 gap-5'>
            ...
            <p className='w-[90%] font-lexend md:text-[20px]/[25px] text-[14px]/[17.5px] font-[400] tracking-[4%]'>Your new password must be different than your last. The password must include:</p>

            <ul className='w-[90%] font-lexend md:text-[20px]/[25px] [14px]/[17.5px] tracking-[4%] font-[600]'>
            ...
            <div className='flex flex-col gap-3 w-[90%]'>
                <label htmlFor="password" className='font-lexend md:text-[20px]/[25px] text-[14px]/[17.5px] font-[400] tracking-[4%]'>Enter New Password</label>
            ...
            <div className='flex flex-col gap-3 w-[90%]'>
                <label htmlFor="confirmPassword" className='font-lexend md:text-[20px]/[25px] text-[14px]/[17.5px] font-[400] tracking-[4%]'>Confirm New Password</label>
