...
const HistoryTimeLine02 = ({ cards, headingWhite, headingBlack }) => {
  ...
  return (
    <div
      className="w-full min-h-[100vh] py-[100px] mx-auto overflow-auto"
      style={{
    ...
    >
      ...
      <div className="max-w-[1440px] min-h-[80vh] w-full mx-auto">
        <Swiper
          autoplay
          breakpoints={{
            1024: {
            ...
            <SwiperSlide key={index}>
              <div className="w-full px-[80px] flex flex-col gap-[80px] relative mx-auto">
                ...
                <div className="absolute md:top-8 top-9 left-16 bg-[#d8e9fe] md:w-[90px] md:h-[90px] w-[90px] h-[90px] rounded-full border-[4px] border-white shadow-md flex justify-center items-center ">
                  <img
                    src={card.icon}
                    className="md:w-[64px] w-[40px] md:h-[64px] h-[40px]"
                  />
                </div>
                ...
                <div className="w-full flex md:flex-row flex-col  mt-[150px] items-center overflow-hidden gap-[48px]">
                  <div className="flex flex-col basis-[40%] gap-[48px] overflow-hidden">
                    <div className="flex flex-col gap-[20px]">
                      <p className="font-[300] font-lexend md:text-[32px]/[51.2px] text-[24px]/[36.2px]">
                        {card.yearRange}
                      </p>
                      <h2 className="font-[600] font-lexend md:text-[40px]/[64px] text-[32px]/[52px]">
                        {card.title}
                      </h2>
                    </div>

                    <p className="font-[400] font-lexend md:text-[26px]/[41.6px] text-[20px]/[36.6px]">
                      {card.description}
                    </p>
                  </div>
                  ...
                  <div className="lg:w-[744px] lg:h-[520px] w-[644px] h-[380px] overflow-hidden flex items-center justify-center">
                    <img
                      ...
                      style={{
                        boxShadow: "0px 2px 10px 0px rgba(0, 69, 197, 0.64)",
                      }}
                    />
                  </div>
                </div>
