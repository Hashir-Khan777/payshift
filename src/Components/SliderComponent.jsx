        ...
        >
          {cards?.map((card, index) => (
            <SwiperSlide key={index}>
              <div
                className={`shrink-0 w-full py-16 px-3 md:px-6 shadow-lg rounded-md  border-4 border-white${index === activeIndex
              ...
              >
                ...
                <button className="mx-auto animated-button flex items-center justify-center gap-7 px-5 py-1 bg-black text-white font-normal rounded-full hover:bg-gray-800">
