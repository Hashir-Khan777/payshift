...
function Card4({cards}) {
  ...
  return (
    <div className='w-[302px] h-[493px] border-[2.29px] border-white rounded-[4.29px] py-[48px] px-[20px] flex flex-col justify-center items-center gap-[32px] shadow-2xl bg-left bg-no-repeat bg-cover'
