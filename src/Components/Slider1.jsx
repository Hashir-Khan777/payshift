      ...
      <div className="flex items-center justify-center mb-4 overflow-hidden">
        ...
        >
          {Array.from({ length: Math.ceil(cards.length / 4) }).map(
            (_, slideIndex) => (
              <SwiperSlide key={slideIndex} className="w-[100%] py-2 px-2">
                    ...
                    .map((card, index) => (
                      ...
                      >
                        ...
                        <div className="w-full flex flex-row justify-between items-center">
                          <p className="font-lexend font-[600] md:text-[20px]/[25px] text-[12px]/[15px] tracking-[4%] text-[#000000]">
                            {card.category}
                          </p>
                          <p className="font-lexend font-[600] md:text-[20px]/[25px] text-[12px]/[15px] tracking-[4%] text-[#5EB43B]">
                            {card.tag}
                          </p>
                        </div>
                        ...
                        <div className="w-full flex flex-row justify-between items-center ps-2">
                          <div className="w-full flex flex-col gap-3 ">
                            <h1 className="mt-3 font-lexend font-[600] md:text-[32px]/[40px] text-[18px]/[22.5px] tracking-[4%] text-[#000000]">
                              {card.projectName}
                            </h1>
                            ...
                            <div className="w-full flex flex-row justify-between items-center whitespace-nowrap">
                              <p className="flex flex-row gap-2 justify-center items-center">
                                <img
                                  ...
                                  alt="Location Icon"
                                  className="md:w-[16px] md:h-[16px] w-[7px] h-[9px]"
                                />
                                <span className="md:text-[20px]/[25px] text-[12px]/[15px] font-[300] font-lexend tracking-[4%]">
                                  Dubai
                                </span>
                              </p>
                              <p className=" md:text-[20px]/[25px] text-[12px]/[15px] font-[300] font-lexend tracking-[4%">
                                1400 SQFT
                              </p>
                              <p className=" md:text-[20px]/[25px] text-[12px]/[15px] font-[300] font-lexend tracking-[4%">
                                2BHK, 2BR
